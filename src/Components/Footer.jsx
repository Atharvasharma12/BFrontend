          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p>
                ...
                <a
                  href="@"
                  class="block text-2xl font-medium text-gray-900 hover:text-yellow-500 dark:text-white sm:text-3xl"
                >
                  Boekenza@gmail.com
                </a>
              </p>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
              <ul class="flex flex-wrap gap-4 text-xs">
                <li>
                  <a
                    href="@"
                    class="text-gray-500 transition hover:text-yellow-500 dark:text-gray-400"
                  >
                    Terms & Conditions
                  </a>
                </li>
              ...
              <p class="mt-8 text-xs text-gray-500 dark:text-gray-400 sm:mt-0">
                &copy; 2023. Boekenza. All rights reserved.
              </p>
            </div>
          </div>
        </div>
